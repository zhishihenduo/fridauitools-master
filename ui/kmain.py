...
class Ui_KmainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # 新增一个拓展 按钮 ext
        self.ext = QtWidgets.QPushButton(self.groupBox)
        self.ext.setMinimumSize(QtCore.QSize(0, 40))
        self.ext.setObjectName("ext")
        self.gridLayout_4.addWidget(self.ext, 3, 0, 1, 1)
        # 新增一个拓展 按钮 ext

        # 新增一个拓展 按钮 reload
        self.reload = QtWidgets.QPushButton(self.groupBox)
        self.reload.setMinimumSize(QtCore.QSize(0, 40))
        self.reload.setObjectName("reload")
        self.gridLayout_4.addWidget(self.reload, 3, 1, 1, 1)
        # 新增一个拓展 按钮 ext
        ...
        # 大傻x 新增 按钮
        self.menu_luocaca = QtWidgets.QAction(self.menuedit)
        self.menu_luocaca.setObjectName("menu_luocaca")
        ...
        self.menuedit.addAction(self.menu_luocaca)
        #
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ext.setText(_translate("MainWindow", "ext"))
        ...
        self.menuAttach.setTitle(_translate("MainWindow", "附加进程1"))
        ...
        self.menu_luocaca.setText(_translate("MainWindow", "大傻逼"))
